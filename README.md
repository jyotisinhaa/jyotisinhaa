...
**Languages:** Java · Python · Golang · JavaScript · C# · SQL

**Frameworks:** Spring Boot · FastAPI · ASP.NET · React

**Databases:** PostgreSQL · MongoDB · Redis · Trino

**Cloud & DevOps:** Docker · Kubernetes · AWS · Grafana
